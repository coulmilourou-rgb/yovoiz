...
export default function PublicProfilePage() {
  ...
  useEffect(() => {
    // Détecter si la page est affichée dans une iframe
  ...
  if (!profile) {
    return (
      <>
        {!isInIframe && <Navbar />}
        <div className={`min-h-screen ${!isInIframe ? 'pt-24' : 'pt-4'} pb-16 px-4`}>
          <div className="max-w-7xl mx-auto">
  ...
  return (
    <>
      {!isInIframe && <Navbar />}
      <div className={`min-h-screen ${!isInIframe ? 'pt-20' : 'pt-4'} pb-16 bg-yo-gray-50`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          
          {/* Bouton retour - masqué dans iframe */}
          {!isInIframe && (
            <Button
              onClick={() => router.back()}
              className="mb-6 bg-white text-yo-gray-700 border border-yo-gray-200 hover:bg-yo-gray-50"
            >
          ...
          <div className="bg-gradient-to-r from-yo-orange via-yo-orange-light to-yo-green h-32 sm:h-48 rounded-t-yo-lg"></div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                      ...
                      <Card className="p-6 bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-100">
                        <div className="flex items-center justify-between">
                          ...
                          <Button className="bg-white text-yo-orange border border-yo-orange hover:bg-yo-orange hover:text-white">
                            Voir ses avis
                          </Button>
                        </div>
                      </Card>
